...
/**
 * copy from
 * [GerardPaligot/discovering-movies](https://github.com/GerardPaligot/discovering-movies/blob/main/data/src/main/java/com/paligot/movies/data/network/ImageLoader.kt)
 *
 */
object ImageLoader {
